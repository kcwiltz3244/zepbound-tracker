const CACHE_NAME = "mzj-v13-cloud-dev-7";
const CORE_ASSETS = ["./", "./index.html", "./styles.css?v=13.0.0-dev.7", "./v13-controls.js?v=13.0.0-dev.7", "./app.js?v=13.0.0-dev.7", "./manifest.json", "./photo-label-guide.png"];
