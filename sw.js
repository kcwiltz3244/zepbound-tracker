const CACHE_NAME = "mzj-v13-cloud-dev-9";
const CORE_ASSETS = ["./", "./index.html", "./styles.css?v=13.0.0-dev.9", "./v13-controls.js?v=13.0.0-dev.9", "./v13-navigation.js?v=13.0.0-dev.9", "./app.js?v=13.0.0-dev.9", "./manifest.json", "./photo-label-guide.png"];
