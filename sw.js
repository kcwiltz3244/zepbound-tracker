const CACHE_NAME = "mzj-v13-cloud-dev-8";
const CORE_ASSETS = ["./", "./index.html", "./styles.css?v=13.0.0-dev.8", "./v13-controls.js?v=13.0.0-dev.8", "./app.js?v=13.0.0-dev.8", "./manifest.json", "./photo-label-guide.png"];
