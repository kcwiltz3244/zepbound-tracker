const CACHE_NAME = "mzj-v13-1-3";
const CORE_ASSETS = ["./", "./index.html", "./styles.css?v=13.1.3", "./v13-controls.js?v=13.1.3", "./v13-navigation.js?v=13.1.3", "./app.js?v=13.1.3", "./manifest.json", "./photo-label-guide.png"];
