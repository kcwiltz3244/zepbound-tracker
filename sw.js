const CACHE_NAME = "mzj-v13-1-0";
const CORE_ASSETS = ["./", "./index.html", "./styles.css?v=13.1.1", "./v13-controls.js?v=13.1.1", "./v13-navigation.js?v=13.1.1", "./app.js?v=13.1.1", "./manifest.json", "./photo-label-guide.png"];
